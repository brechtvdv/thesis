...
\hypersetup{
    pdfauthor = {Brecht Van de Vyvere},
    pdftitle = {Uitbreidbare web-gebaseerde intermodale routeplanner voor België},
    pdfsubject = {Deze masterproef beschrijft de werking van clientside routeplanning.},
    pdfkeywords = {Linked Connections, masterproef, Linked Data Fragments}
}
